 ...
 * @module     report_mobile/chart_line
 */
define(['report_mobile/chart_base'], function(Base) {

    /**
     * Line chart.
     *
     * @alias module:report_mobile/chart_line
     * @extends {module:report_mobile/chart_base}
     * @class
     */
    function Line() {
