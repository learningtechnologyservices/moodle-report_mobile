 ...
 * @module     report_mobile/chart_output_chartjs
 */
define([
    'jquery',
    'report_mobile/chartjs',
    'report_mobile/chart_axis',
    'report_mobile/chart_bar',
    'report_mobile/chart_output_base',
    'report_mobile/chart_line',
    'report_mobile/chart_pie',
    'report_mobile/chart_series'
     ...
     *
     * @class
     * @alias module:report_mobile/chart_output_chartjs
     * @extends {module:report_mobile/chart_output_base}
     */
    function Output() {
     ...
     *
     * @protected
     * @param {module:report_mobile/chart_series} series The series.
     * @returns {Bool}
     */
