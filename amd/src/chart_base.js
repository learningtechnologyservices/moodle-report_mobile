 ...
 * @module     report_mobile/chart_base
 */
define(['report_mobile/chart_series', 'report_mobile/chart_axis'], function(Series, Axis) {
     ...
     *
     * {@link module:report_mobile/chart_base#_setDefault} to set the defaults on instantiation.
     *
     * @alias module:report_mobile/chart_base
     * @class
     */
    function Base() {
        this._series = [];
     ...
     *
     * @protected
     * @type {module:report_mobile/chart_series[]}
     */
     ...
     *
     * @protected
     * @type {module:report_mobile/chart_axis[]}
     */
     ...
     *
     * @param {module:report_mobile/chart_series} series The series to add.
     */
     ...
     * @static
     * @method create
     * @param {module:report_mobile/chart_base} Klass The class oject representing the type of chart to instantiate.
     * @param {Object} data The data of the chart.
     * @return {module:report_mobile/chart_base}
     */
     ...
     * @return {module:report_mobile/chart_axis}
     */
     ...
     * Get the series.
     *
     * @return {module:report_mobile/chart_series[]}
     */
     ...
     *
     * @see module:report_mobile/chart_base#TYPE
     * @return {String}
     */
     ...
     *
     * @param {module:report_mobile/chart_axis} axis The axis.
     * @param {Number} [index=0] The index of the axis.
     */
     ...
     * @param {module:report_mobile/chart_axis} axis The axis to validate.
     * @param {Number} [index=0] The index of the axis.
     */
     ...
     *
     * @protected
     * @param {module:report_mobile/chart_series} series The series to validate.
     */
