...
define(['jquery'], function($) {
     ...
     * Chart builder.
     *
     * @exports report_mobile/chart_builder
     */
    var module = {
         ...
         * deferring most of the logic to {@link module:report_mobile/chart_base.create}.
         *
        ...
        make: function(data) {
            ...
            require(['report_mobile/chart_' + data.type], function(Klass) {
